...
if( $reqV ){?>
		...
		<div class="table">
			...
			foreach($TPL['categories'] as $row){
				...
				echo '<div class="row rows"><a class="update" data-id="' . $row['category_id'] . '" href="action.php?y=edit_category&id=' . $row['category_id'] . '" title="Update' . $row['category_name'] . '"><img src="../images/edit.png" width="20" height="20"></a></div>';
