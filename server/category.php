	...
	<div class="form">
		...
		if ($reqV) { ?>
			...
			foreach ($TPL['categories'] as $row) {
				...
				echo '<div class="row rows"><a href="action.php?y=edit_category&id=' . $row['category_id'] . '" title="Update' . $row['category_name'] . '"><img src="../images/edit.png" width="20" height="20"></a></div>';
				echo '<div class="row rows"><a href="action.php?y=del_category&id=' . $row['category_id'] . '" title="Delete' . $row['category_name'] . '"><img src="../images/delete.png" width="20" height="20"></a></div>';
				echo '</div>';
			}
			?>
		<?php } ?>
