...
=======
			...
			<div class="qst qMargin">	
				<label for="name" class="qst lbl">Client Name :</label>
				<input type="text" id="name" name="name" class="inputFlex" value="<?php echo ( $reqY ? $TPL['edit_client']['client_name'] : "" ); ?>" required>
			</div>
			
			<div class="cEmail qst qMargin">
				<label for="email" class="qst lbl">Client Email :</label>
				<input type="text" id="email" name="email" class="inputFlex" value="<?php echo ( $reqY ? $TPL['edit_client']['client_email'] : "" ); ?>" required>
			</div>
			
			<div class="cPhone qst qMargin">
				<label for="phone" class="qst lbl">Client Phone :</label>
				<input type="text" id="phone" name="phone" class="inputFlex" value="<?php echo ( $reqY ? $TPL['edit_client']['client_phone'] : "" ); ?>" required> 
			</div>
			
			<div class="cAddress qst qMargin">
				<label for="address" class="qst lbl">Client Address :</label>
				<input type="text" id="address" name="address" class="inputFlex" value="<?php echo ( $reqY ? $TPL['edit_client']['client_address'] : "" ); ?>" required>
			</div>
			
			<div class="cDesc qst qMargin">
				<label for="description" class="qst lbl">Client Description :</label>
				<textarea id="description" rows="4" name="description" class="inputFlex" required><?php echo ( $reqY ? $TPL['edit_client']['client_description'] : "" ); ?></textarea>
			</div>
